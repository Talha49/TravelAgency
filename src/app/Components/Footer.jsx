...
import ResFoot from './ResFoot';
const Footer = () => {
    return (
        <div className='w-full  h-full bg-[#86b6b113]'>
            <div className='hidden md:block'>
            <div className='  max-w-[1340px] grid grid-cols-4 gap-9 border-b-2 pb-6 border-black place-items-center  mx-auto px-7 py-4'>
               <div className='logo '> 
...
<path d="M899.6 538.3H131.2c-40.7 0-118.6-28.8-118.6-73.9 0-13.2 19.2-31.8 56-43.7l-45-159.8c-0.8-2.7-0.2-5.6 1.5-7.9 1.7-2.2 4.4-3.6 7.2-3.6H92c3.1 0 6 1.6 7.6 4.2l81.5 129.3h718.5c20.9 0 49.3 8.4 72.5 21.3 28.6 16 44.4 36 44.4 56.3s-15.8 40.3-44.4 56.3c-23.2 13.1-51.6 21.5-72.5 21.5zM30.7 464.7c0.4 28.7 62.9 55.6 100.6 55.6h768.4c17.8 0 43.4-7.6 63.7-19 22.4-12.5 35.2-27.3 35.2-40.6s-12.8-28.1-35.2-40.6c-20.3-11.4-46-19-63.7-19H176.2c-3.1 0-6-1.6-7.6-4.2L87 267.4H44.2l44.2 156.9c0.7 2.3 0.4 4.8-0.8 6.9-1.2 2.1-3.1 3.6-5.5 4.2-35.5 9.8-50.2 24.9-51.4 29.3z" fill="#3E4152"/>
            ...
            <div>
                <p>Travel With Full Enthusiastic & Fresh Environment </p>
            ...
            <BiLogoTwitter />
                ...
                <div >
                    ...
                    <Link href = "/About" className='text-lg mt-3'>About Us</Link>
                    <Link href = "#Pl" className='text-lg mt-3'>Places</Link>
                    <Link href = "#to" className='text-lg mt-3'>Tours</Link>
                    <Link href = "/Contact" className='text-lg mt-3'>Contact Us</Link>
                    </div>
                </div>

                <div>
               <h2 className='font-bold text-2xl'>Destinations</h2>
               <p className='text-lg mt-3'>Maldives</p>
               <p className='text-lg mt-3'>Columbo</p>
               <p className='text-lg mt-3'>Baku</p>
               <p className='text-lg mt-3'>Bali</p>
                

            </div>
            <div className=''>
                <h2 className='font-bold text-2xl'>Information</h2>
                <p className='flex items-center text-lg gap-2 mt-3'><BsTelephoneInbound className='text-lg' /> : +92-3265420488</p>
                <p className='flex items-center text-lg gap-2 mt-3'>  <CgMail className='text-lg'/> : ghaurit82@gmail.com</p>
                <p className='flex items-center text-lg gap-2 mt-3'><PiAddressBookThin className='text-lg'/> : America, USA, TX, 4089</p>
            </div>
            ...
            <div className='text-center '><p>CopyWright @2003. Made by Talha Ghauri </p></div>
            </div>
            <ResFoot  />

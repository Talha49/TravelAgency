...
const ResFoot = () => {
    return (
        <div className='md:hidden bg-[#86b6b113]'>
           <div className='main border-b pb-2'>
            <div className='flex items-center gap-1 ml-2'>
            <svg width="20px" height="30px" viewBox="0 0 1024.00 1024.00" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000" transform="matrix(1, 0, 0, 1, 0, 0)">
...
<path d="M899.6 538.3H131.2c-40.7 0-118.6-28.8-118.6-73.9 0-13.2 19.2-31.8 56-43.7l-45-159.8c-0.8-2.7-0.2-5.6 1.5-7.9 1.7-2.2 4.4-3.6 7.2-3.6H92c3.1 0 6 1.6 7.6 4.2l81.5 129.3h718.5c20.9 0 49.3 8.4 72.5 21.3 28.6 16 44.4 36 44.4 56.3s-15.8 40.3-44.4 56.3c-23.2 13.1-51.6 21.5-72.5 21.5zM30.7 464.7c0.4 28.7 62.9 55.6 100.6 55.6h768.4c17.8 0 43.4-7.6 63.7-19 22.4-12.5 35.2-27.3 35.2-40.6s-12.8-28.1-35.2-40.6c-20.3-11.4-46-19-63.7-19H176.2c-3.1 0-6-1.6-7.6-4.2L87 267.4H44.2l44.2 156.9c0.7 2.3 0.4 4.8-0.8 6.9-1.2 2.1-3.1 3.6-5.5 4.2-35.5 9.8-50.2 24.9-51.4 29.3z" fill="#3E4152"/>
                ...
                <h2 className='text-[15px]  font-bold tracking-wider'>TK Agency</h2>
             
            </div>
            <div className='ml-2 mt-1'>
                <p className='text-sm ]'>Travel With Full Enthusiastic <br />& Fresh Environment </p>
            </div>
            ...
            <div>
                ...
                <ul>
                    <Link href='/'><li className='text-sm gap-1 mt-2'>Home</li></Link>
                    <Link href='#to'><li className='text-sm gap-1 mt-2'>Tours</li></Link>
                    <Link href='/Contact'><li className='text-sm gap-1 mt-2'>Contact</li></Link>
                    <Link href='#Pl'><li className='text-sm gap-1 mt-2'>Places</li></Link>
                </ul>

            </div>
            <div className=''>
                <h2 className='font-bold text-md'>Information</h2>
                <p className='flex items-center text-sm gap-1 mt-2'><BsTelephoneInbound className='text-sm' /> : +92-3265420488</p>
                <p className='flex items-center text-sm gap-1 mt-2'>  <CgMail className='text-sm'/> : ghaurit82@gmail.com</p>
                <p className='flex items-center text-sm gap-1 mt-2'><PiAddressBookThin className='text-sm'/> : America, USA, TX, 4089</p>
            </div>


               
            <div>
               <h2 className='font-bold text-md mt-1'>Destinations</h2>
               <p className='text-sm mt-2'>Maldives</p>
               <p className='text-sm mt-2'>Columbo</p>
               <p className='text-sm mt-2'>Baku</p>
               <p className='text-sm mt-2'>Bali</p>
            ...
            <div className='flex items-center gap-1 mt-2 '>
                ...
                <div className='rounded-full shadow-xl shadow-gray-600 p-1 cursor-pointer hover:scale-105 ease-in-out duration-300'>
                    <BiLogoFacebook  />
                    </div>
                    <div className='rounded-full shadow-xl shadow-gray-600 p-1 cursor-pointer hover:scale-105 ease-in-out duration-300'>
            <BiLogoInstagram />
            ...
            <div className='text-center text-sm'><p>CopyWright @2003. Made by Talha Ghauri </p></div>
           </div>

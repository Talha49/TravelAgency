...
const page = () => {
          ...
          <div className="block rounded-lg bg-[hsla(0,0%,100%,0.7)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
            <div className="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="mx-auto mb-6 text-center md:mb-0">
                ...
                <h6 className="font-medium">+92 3265420488</h6>
              </div>
  ...
  <div className="mb-4">
    <input
      ...
      required
      className="w-full p-2 rounded border bg-transparent outline-none focus:placeholder-opacity-100 focus:text-primary"
    />
  </div>
  <div className="mb-4">
    <input
  ...
  <div className="mb-4">
    <textarea
      className="w-full p-2 rounded border bg-transparent outline-none focus:placeholder-opacity-100"
      id="message"
      name="message"
  ...
  <button
    type="submit"
    className="w-full py-2 rounded bg-green-300 text-xs font-medium uppercase text-white hover:bg-primary-600 focus:outline-none focus:bg-primary-600 active:bg-primary-700"
  >
    Send
  </button>
</form>
              <div className="bg-slate-100 flex flex-col mt-4">
                {formData.error &&
                  formData.error.map((e, index) => (
                    <div key={index}
                      className={`${formData.success ? "text-green-800" : "text-red-600"} px-5 py-2`}>
                      {e}
                    </div>
                  ))}
              </div>
